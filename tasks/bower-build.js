...
module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('bower-build', 'Build bower dependencies', function () {
    ...
    var cssMatcher = /\.css$/
    var jsMatcher = /\.js$/
    var fontMatcher = /\.(eot|otf|svg|ttf|woff)$/
    var options = _.extend(defaultOptions, this.data)
    var dependencies = require('wiredep')(options.wiredep)
    var done = {}
    ...
    var addCssFile = function (name, code) {
      ...
      htmlImportCss += '<link rel="stylesheet" href="' + options.htmlPrefixCss + file + '" />\n'
    ...
    var addJsFile = function (name, code) {
      ...
      htmlImportJs += '<script src="' + options.htmlPrefixJs + file + '"></script>\n'
